...
!function (a) {
  ...
  function b() {
    ...
    var b = this,
      ...
      var e = a(this),
          f = e.parent("li"),
          g = f.children("ul");return d.preventDefault(), f.hasClass(c) && !b.options.doubleTapToGo ? (b.hide(g), e.attr("aria-expanded", !1)) : (b.show(g), e.attr("aria-expanded", !0)), b.options.doubleTapToGo && b.doubleTapToGo(e) && "#" !== e.attr("href") && "" !== e.attr("href") ? (d.stopPropagation(), void (document.location = e.attr("href"))) : void 0;
    });
...
function _strlen(e) {
  var t = e + "",
      a = 0,
      r = "",
      n = 0;if (!this.php_js || !this.php_js.ini || !this.php_js.ini["unicode.semantics"] || "on" !== this.php_js.ini["unicode.semantics"].local_value.toLowerCase()) return e.length;var i = function i(e, t) {
    var a = e.charCodeAt(t),
        r = "",
        n = "";if (55296 <= a && a <= 56319) {
      if (e.length <= t + 1) throw "High surrogate without following low surrogate";if (r = e.charCodeAt(t + 1), 56320 > r || r > 57343) throw "High surrogate without following low surrogate";return e.charAt(t) + e.charAt(t + 1);
    }if (56320 <= a && a <= 57343) {
      if (0 === t) throw "Low surrogate without preceding high surrogate";if (n = e.charCodeAt(t - 1), 55296 > n || n > 56319) throw "Low surrogate without preceding high surrogate";return !1;
    }return e.charAt(t);
  };for (a = 0, n = 0; a < t.length; a++) {
    (r = i(t, a)) !== !1 && n++;
  }return n;
  ...
  var t = {},
      ...
      s = {};e: for (r in e) {
    for (n = 1; n < a; n++) {
      s = arguments[n];for (i in s) {
        if (s[i] === e[r]) continue e;
      }t[r] = e[r];
    }
  }return t;
}function _strtotime(e, t) {
  function a(e, t, a) {
    var r,
        n = u[t];"undefined" != typeof n && (r = n - l.getDay(), 0 === r ? r = 7 * a : r > 0 && "last" === e ? r -= 7 : r < 0 && "next" === e && (r += 7), l.setDate(l.getDate() + r));
  }function r(e) {
    var t = e.split(" "),
        r = t[0],
        n = t[1].substring(0, 3),
        i = /\d+/.test(r),
        s = "ago" === t[2],
        o = ("last" === r ? -1 : 1) * (s ? -1 : 1);if (i && (o *= parseInt(r, 10)), d.hasOwnProperty(n) && !t[1].match(/^mon(day|\.)?$/i)) return l["set" + d[n]](l["get" + d[n]]() + o);if ("wee" === n) return l.setDate(l.getDate() + 7 * o);if ("next" === r || "last" === r) a(r, n, o);else if (!i) return !1;return !0;
  }var n,
      i,
      s,
      o,
      ...
      m,
      f,
      g = !1;if (!e) return g;if (e = e.replace(/^\s+|\s+$/g, "").replace(/\s{2,}/g, " ").replace(/[\t\r\n]/g, "").toLowerCase(), i = e.match(/^(\d{1,4})([\-\.\/\:])(\d{1,2})([\-\.\/\:])(\d{1,4})(?:\s(\d{1,2}):(\d{2})?:?(\d{2})?)?(?:\s([A-Z]+)?)?$/), i && i[2] === i[4]) if (i[1] > 1901) switch (i[2]) {case "-":
      return i[3] > 12 || i[5] > 31 ? g : new Date(i[1], parseInt(i[3], 10) - 1, i[5], i[6] || 0, i[7] || 0, i[8] || 0, i[9] || 0) / 1e3;case ".":
      return g;case "/":
      return i[3] > 12 || i[5] > 31 ? g : new Date(i[1], parseInt(i[3], 10) - 1, i[5], i[6] || 0, i[7] || 0, i[8] || 0, i[9] || 0) / 1e3;} else if (i[5] > 1901) switch (i[2]) {case "-":
      return i[3] > 12 || i[1] > 31 ? g : new Date(i[5], parseInt(i[3], 10) - 1, i[1], i[6] || 0, i[7] || 0, i[8] || 0, i[9] || 0) / 1e3;case ".":
      return i[3] > 12 || i[1] > 31 ? g : new Date(i[5], parseInt(i[3], 10) - 1, i[1], i[6] || 0, i[7] || 0, i[8] || 0, i[9] || 0) / 1e3;case "/":
      return i[1] > 12 || i[3] > 31 ? g : new Date(i[5], parseInt(i[1], 10) - 1, i[3], i[6] || 0, i[7] || 0, i[8] || 0, i[9] || 0) / 1e3;} else switch (i[2]) {case "-":
      return i[3] > 12 || i[5] > 31 || i[1] < 70 && i[1] > 38 ? g : (o = i[1] >= 0 && i[1] <= 38 ? +i[1] + 2e3 : i[1], new Date(o, parseInt(i[3], 10) - 1, i[5], i[6] || 0, i[7] || 0, i[8] || 0, i[9] || 0) / 1e3);case ".":
      return i[5] >= 70 ? i[3] > 12 || i[1] > 31 ? g : new Date(i[5], parseInt(i[3], 10) - 1, i[1], i[6] || 0, i[7] || 0, i[8] || 0, i[9] || 0) / 1e3 : i[5] < 60 && !i[6] ? i[1] > 23 || i[3] > 59 ? g : (s = new Date(), new Date(s.getFullYear(), s.getMonth(), s.getDate(), i[1] || 0, i[3] || 0, i[5] || 0, i[9] || 0) / 1e3) : g;case "/":
      return i[1] > 12 || i[3] > 31 || i[5] < 70 && i[5] > 38 ? g : (o = i[5] >= 0 && i[5] <= 38 ? +i[5] + 2e3 : i[5], new Date(o, parseInt(i[1], 10) - 1, i[3], i[6] || 0, i[7] || 0, i[8] || 0, i[9] || 0) / 1e3);case ":":
      return i[1] > 23 || i[3] > 59 || i[5] > 59 ? g : (s = new Date(), new Date(s.getFullYear(), s.getMonth(), s.getDate(), i[1] || 0, i[3] || 0, i[5] || 0) / 1e3);}if ("now" === e) return null === t || isNaN(t) ? new Date().getTime() / 1e3 | 0 : 0 | t;if (!isNaN(n = Date.parse(e))) return n / 1e3 | 0;if ((i = e.match(/^([0-9]{4}-[0-9]{2}-[0-9]{2})[ t]([0-9]{2}:[0-9]{2}:[0-9]{2}(\.[0-9]+)?)([\+-][0-9]{2}(:[0-9]{2})?|z)/)) && ("z" == i[4] ? i[4] = "Z" : i[4].match(/^([\+-][0-9]{2})$/) && (i[4] = i[4] + ":00"), !isNaN(n = Date.parse(i[1] + "T" + i[2] + i[4])))) return n / 1e3 | 0;if (l = t ? new Date(1e3 * t) : new Date(), u = { sun: 0, mon: 1, tue: 2, wed: 3, thu: 4, fri: 5, sat: 6 }, d = { yea: "FullYear", mon: "Month", day: "Date", hou: "Hours", min: "Minutes", sec: "Seconds" }, c = "(years?|months?|weeks?|days?|hours?|minutes?|min|seconds?|sec|sunday|sun\\.?|monday|mon\\.?|tuesday|tue\\.?|wednesday|wed\\.?|thursday|thu\\.?|friday|fri\\.?|saturday|sat\\.?)", m = "([+-]?\\d+\\s" + c + "|(last|next)\\s" + c + ")(\\sago)?", i = e.match(new RegExp(m, "gi")), !i) return g;for (f = 0, h = i.length; f < h; f++) {
    if (!r(i[f])) return g;
  }return l.getTime() / 1e3;
}function _is_numeric(e) {
  var t = " \n\r\t\f\x0B\xA0\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200A\u200B\u2028\u2029\u3000";return ("number" == typeof e || "string" == typeof e && t.indexOf(e.slice(-1)) === -1) && "" !== e && !isNaN(e);
}!function (e) {
  ...
  e.extend(e.fn, { validate: function validate(t) {
      if (!this.length) return void (t && t.debug && window.console);var a = e.data(this[0], "validator");return a ? a : (this.attr("novalidate", "novalidate"), a = new e.validator(t, this[0]), e.data(this[0], "validator", a), a.settings.onsubmit && (this.on("click.validate", ":submit", function (t) {
        ...
        function r() {
          var r, n;return !a.settings.submitHandler || (a.submitButton && (r = e("<input type='hidden'/>").attr("name", a.submitButton.name).val(e(a.submitButton).val()).appendTo(a.currentForm)), n = a.settings.submitHandler.call(a, a.currentForm, t), a.submitButton && r.remove(), void 0 !== n && n);
      ...
      var t, a, r;return e(this[0]).is("form") ? t = this.validate().form() : (r = [], t = !0, a = e(this[0].form).validate(), this.each(function () {
        t = a.element(this) && t, r = r.concat(a.errorList);
      }), a.errorList = r), t;
    }, rules: function rules(t, a) {
      var r,
          n,
          i,
          s,
          o,
          l,
          u = this[0];if (t) switch (r = e.data(u.form, "validator").settings, n = r.rules, i = e.validator.staticRules(u), t) {case "add":
          e.extend(i, e.validator.normalizeRule(a)), delete i.messages, n[u.name] = i, a.messages && (r.messages[u.name] = e.extend(r.messages[u.name], a.messages));break;case "remove":
          return a ? (l = {}, e.each(a.split(/\s/), function (t, a) {
            l[a] = i[a], delete i[a], "required" === a && e(u).removeAttr("aria-required");
          }), l) : (delete n[u.name], i);}return s = e.validator.normalizeRules(e.extend({}, e.validator.classRules(u), e.validator.attributeRules(u), e.validator.dataRules(u), e.validator.staticRules(u)), u), s.required && (o = s.required, delete s.required, s = e.extend({ required: o }, s), e(u).attr("aria-required", "true")), s.remote && (o = s.remote, delete s.remote, s = e.extend(s, { remote: o })), s;
    ...
    return 1 === arguments.length ? function () {
      var a = e.makeArray(arguments);return a.unshift(t), e.validator.format.apply(this, a);
  ...
  }, e.extend(e.validator, { defaults: { messages: {}, groups: {}, rules: {}, errorClass: "error", validClass: "valid", errorElement: "label", focusCleanup: !1, focusInvalid: !0, errorContainer: e([]), errorLabelContainer: e([]), onsubmit: !0, ignore: ":hidden", ignoreTitle: !1, onfocusin: function onfocusin(e) {
        this.lastActive = e, this.settings.focusCleanup && (this.settings.unhighlight && this.settings.unhighlight.call(this, e, this.settings.errorClass, this.settings.validClass), this.hideThese(this.errorsFor(e)));
      }, onfocusout: function onfocusout(e) {
        this.checkable(e) || !(e.name in this.submitted) && this.optional(e) || this.element(e);
      }, onkeyup: function onkeyup(t, a) {
        var r = [16, 17, 18, 20, 35, 36, 37, 38, 39, 40, 45, 144, 225];9 === a.which && "" === this.elementValue(t) || e.inArray(a.keyCode, r) !== -1 || (t.name in this.submitted || t === this.lastElement) && this.element(t);
      }, onclick: function onclick(e) {
        e.name in this.submitted ? this.element(e) : e.parentNode.name in this.submitted && this.element(e.parentNode);
      }, highlight: function highlight(t, a, r) {
        "radio" === t.type ? this.findByName(t.name).addClass(a).removeClass(r) : e(t).addClass(a).removeClass(r);
      }, unhighlight: function unhighlight(t, a, r) {
      ...
      e.extend(e.validator.defaults, t);
        ...
        function t(t) {
          var a = e.data(this.form, "validator"),
              ...
              n = a.settings;n[r] && !e(this).is(n.ignore) && n[r].call(a, this, t);
        }this.labelContainer = e(this.settings.errorLabelContainer), this.errorContext = this.labelContainer.length && this.labelContainer || e(this.currentForm), this.containers = e(this.settings.errorContainer).add(this.settings.errorLabelContainer), this.submitted = {}, this.valueCache = {}, this.pendingRequest = 0, this.pending = {}, this.invalid = {}, this.reset();var a,
            r = this.groups = {};e.each(this.settings.groups, function (t, a) {
        ...
        var a = this.clean(t),
            ...
            n = !0;return this.lastElement = r, void 0 === r ? delete this.invalid[a.name] : (this.prepareElement(r), this.currentElements = e(r), n = this.check(r) !== !1, n ? delete this.invalid[r.name] : this.invalid[r.name] = !0), e(t).attr("aria-invalid", !n), this.numberOfInvalids() || (this.toHide = this.toHide.add(this.containers)), this.showErrors(), n;
      }, showErrors: function showErrors(t) {
        if (t) {
          e.extend(this.errorMap, t), this.errorList = [];for (var a in t) {
            this.errorList.push({ message: t[a], element: this.findByName(a)[0] });
          }this.successList = e.grep(this.successList, function (e) {
            return !(e.name in t);
          });
        }this.settings.showErrors ? this.settings.showErrors.call(this, this.errorMap, this.errorList) : this.defaultShowErrors();
      }, resetForm: function resetForm() {
        e.fn.resetForm && e(this.currentForm).resetForm(), this.submitted = {}, this.lastElement = null, this.prepareForm(), this.hideErrors();var t,
            a = this.elements().removeData("previousValue").removeAttr("aria-invalid");if (this.settings.unhighlight) for (t = 0; a[t]; t++) {
          this.settings.unhighlight.call(this, a[t], this.settings.errorClass, "");
        ...
        var t = this,
            a = {};return e(this.currentForm).find("input, select, textarea").not(":submit, :reset, :image, :disabled").not(this.settings.ignore).filter(function () {
          return !this.name && t.settings.debug && window.console, !(this.name in a || !t.objectLength(e(this).rules())) && (a[this.name] = !0, !0);
        });
        ...
        var a,
            r = e(t),
            n = t.type;return "radio" === n || "checkbox" === n ? this.findByName(t.name).filter(":checked").val() : "number" === n && "undefined" != typeof t.validity ? !t.validity.badInput && r.val() : (a = r.val(), "string" == typeof a ? a.replace(/\r/g, "") : a);
      }, check: function check(t) {
        t = this.validationTargetFor(this.clean(t));var a,
            r,
            n,
            i = e(t).rules(),
          ...
          return t;
            ...
            o = !1,
            l = this.elementValue(t);for (r in i) {
          n = { method: r, parameters: i[r] };try {
            if (a = e.validator.methods[r].call(this, l, t, n.parameters), "dependency-mismatch" === a && 1 === s) {
              o = !0;continue;
            }if (o = !1, "pending" === a) return void (this.toHide = this.toHide.not(this.errorsFor(t)));if (!a) return this.formatAndAdd(t, n), !1;
          } catch (u) {
            throw this.settings.debug && window.console, u instanceof TypeError && (u.message += ".  Exception occurred when checking element " + t.id + ", check the '" + n.method + "' method."), u;
          }
        }if (!o) return this.objectLength(i) && this.successList.push(t), !0;
      }, customDataMessage: function customDataMessage(t, a) {
        ...
        var a = this.settings.messages[e];return a && (a.constructor === String ? a : a[t]);
      }, findDefined: function findDefined() {
        for (var e = 0; e < arguments.length; e++) {
          if (void 0 !== arguments[e]) return arguments[e];
        }
      }, defaultMessage: function defaultMessage(t, a) {
      ...
      }, formatAndAdd: function formatAndAdd(t, a) {
        var r = this.defaultMessage(t, a.method),
            n = /\$?\{(\d+)\}/g;"function" == typeof r ? r = r.call(this, a.parameters, t) : n.test(r) && (r = e.validator.format(r.replace(n, "{$1}"), a.parameters)), this.errorList.push({ message: r, element: t, method: a.method }), this.errorMap[t.name] = r, this.submitted[t.name] = r;
      }, addWrapper: function addWrapper(e) {
        return this.settings.wrapper && (e = e.add(e.parent(this.settings.wrapper))), e;
      }, defaultShowErrors: function defaultShowErrors() {
        var e, t, a;for (e = 0; this.errorList[e]; e++) {
      ...
      }, showLabel: function showLabel(t, a) {
        var r,
            n,
            i,
            s = this.errorsFor(t),
            o = this.idOrName(t),
            l = e(t).attr("aria-describedby");s.length ? (s.removeClass(this.settings.validClass).addClass(this.settings.errorClass), s.html(a)) : (s = e("<" + this.settings.errorElement + ">").attr("id", o + "-error").addClass(this.settings.errorClass).html(a || ""), r = s, this.settings.wrapper && (r = s.hide().show().wrap("<" + this.settings.wrapper + "/>").parent()), this.labelContainer.length ? this.labelContainer.append(r) : this.settings.errorPlacement ? this.settings.errorPlacement(r, e(t)) : r.insertAfter(t), s.is("label") ? s.attr("for", o) : 0 === s.parents("label[for='" + o + "']").length && (i = s.attr("id").replace(/(:|\.|\[|\]|\$)/g, "\\$1"), l ? l.match(new RegExp("\\b" + i + "\\b")) || (l += " " + i) : l = i, e(t).attr("aria-describedby", l), n = this.groups[t.name], n && e.each(this.groups, function (t, a) {
          a === n && e("[name='" + t + "']", this.currentForm).attr("aria-describedby", s.attr("id"));
        ...
        var a = this.idOrName(t),
            ...
            n = "label[for='" + a + "'], label[for='" + a + "'] *";return r && (n = n + ", #" + r.replace(/\s+/g, ", #")), this.errors().filter(n);
      ...
      }, getLength: function getLength(t, a) {
        switch (a.nodeName.toLowerCase()) {case "select":
            return e("option:selected", a).length;case "input":
            if (this.checkable(a)) return this.findByName(a.name).filter(":checked").length;}return t.length;
        ...
        return !this.dependTypes[typeof e === "undefined" ? "undefined" : _typeof(e)] || this.dependTypes[typeof e === "undefined" ? "undefined" : _typeof(e)](e, t);
          ...
          return e;
        }, string: function string(t, a) {
          return !!e(t, a.form).length;
        }, "function": function _function(e, t) {
          return e(t);
        } }, optional: function optional(t) {
        var a = this.elementValue(t);return !e.validator.methods.required.call(this, a, t) && "dependency-mismatch";
      }, startRequest: function startRequest(e) {
        this.pending[e.name] || (this.pendingRequest++, this.pending[e.name] = !0);
      }, stopRequest: function stopRequest(t, a) {
      ...
      } }, classRuleSettings: { required: { required: !0 }, email: { email: !0 }, url: { url: !0 }, date: { date: !0 }, dateISO: { dateISO: !0 }, number: { number: !0 }, digits: { digits: !0 }, creditcard: { creditcard: !0 } }, addClassRules: function addClassRules(t, a) {
    ...
    }, normalizeAttributeRule: function normalizeAttributeRule(e, t, a, r) {
      ...
      var a,
          ...
          n = {},
          i = e(t),
          s = t.getAttribute("type");for (a in e.validator.methods) {
        "required" === a ? (r = t.getAttribute(a), "" === r && (r = !0), r = !!r) : r = i.attr(a), this.normalizeAttributeRule(n, s, a, r);
      ...
      var a,
          ...
          i = e(t),
          s = t.getAttribute("type");for (a in e.validator.methods) {
        r = i.data("rule" + a.charAt(0).toUpperCase() + a.substring(1).toLowerCase()), this.normalizeAttributeRule(n, s, a, r);
      }return n;
    }, staticRules: function staticRules(t) {
      var a = {},
          r = e.data(t.form, "validator");return r.settings.rules && (a = e.validator.normalizeRule(r.settings.rules[t.name]) || {}), a;
    }, normalizeRules: function normalizeRules(t, a) {
      return e.each(t, function (r, n) {
        if (n === !1) return void delete t[r];if (n.param || n.depends) {
          var i = !0;switch (_typeof(n.depends)) {case "string":
              i = !!e(n.depends, a.form).length;break;case "function":
              i = n.depends.call(a, a);}i ? t[r] = void 0 === n.param || n.param : delete t[r];
        }
      }), e.each(t, function (r, n) {
        t[r] = e.isFunction(n) ? n(a) : n;
      }), e.each(["minlength", "maxlength"], function () {
        t[this] && (t[this] = Number(t[this]));
      }), e.each(["rangelength", "range"], function () {
        var a;t[this] && (e.isArray(t[this]) ? t[this] = [Number(t[this][0]), Number(t[this][1])] : "string" == typeof t[this] && (a = t[this].replace(/[\[\]]/g, "").split(/[\s,]+/), t[this] = [Number(a[0]), Number(a[1])]));
      }), e.validator.autoCreateRanges && (null != t.min && null != t.max && (t.range = [t.min, t.max], delete t.min, delete t.max), null != t.minlength && null != t.maxlength && (t.rangelength = [t.minlength, t.maxlength], delete t.minlength, delete t.maxlength)), t;
    }, normalizeRule: function normalizeRule(t) {
      if ("string" == typeof t) {
        var a = {};e.each(t.split(/\s/), function () {
          a[this] = !0;
        }), t = a;
      }return t;
    }, addMethod: function addMethod(t, a, r) {
      e.validator.methods[t] = a, e.validator.messages[t] = void 0 !== r ? r : e.validator.messages[t], a.length < 3 && e.validator.addClassRules(t, e.validator.normalizeRule(t));
    }, methods: { required: function required(t, a, r) {
        if (!this.depend(r, a)) return "dependency-mismatch";if ("select" === a.nodeName.toLowerCase()) {
          var n = e(a).val();return n && n.length > 0;
        ...
        if (this.optional(t)) return "dependency-mismatch";if (/[^0-9 \-]+/.test(e)) return !1;var a,
            r,
            n = 0,
            i = 0,
            s = !1;if (e = e.replace(/\D/g, ""), e.length < 13 || e.length > 19) return !1;for (a = e.length - 1; a >= 0; a--) {
          r = e.charAt(a), i = parseInt(r, 10), s && (i *= 2) > 9 && (i -= 9), n += i, s = !s;
        }return n % 10 === 0;
      }, minlength: function minlength(t, a, r) {
        var n = e.isArray(t) ? t.length : this.getLength(t, a);return this.optional(a) || n >= r;
      }, maxlength: function maxlength(t, a, r) {
        var n = e.isArray(t) ? t.length : this.getLength(t, a);return this.optional(a) || n <= r;
      }, rangelength: function rangelength(t, a, r) {
        var n = e.isArray(t) ? t.length : this.getLength(t, a);return this.optional(a) || n >= r[0] && n <= r[1];
      ...
      }, equalTo: function equalTo(t, a, r) {
        var n = e(r);return this.settings.onfocusout && n.off(".validate-equalTo").on("blur.validate-equalTo", function () {
          e(a).valid();
        }), t === n.val();
      }, remote: function remote(t, a, r) {
        if (this.optional(a)) return "dependency-mismatch";var n,
            i,
            s = this.previousValue(a);return this.settings.messages[a.name] || (this.settings.messages[a.name] = {}), s.originalMessage = this.settings.messages[a.name].remote, this.settings.messages[a.name].remote = s.message, r = "string" == typeof r && { url: r } || r, s.old === t ? s.valid : (s.old = t, n = this, this.startRequest(a), i = {}, i[a.name] = t, e.ajax(e.extend(!0, { mode: "abort", port: "validate" + a.name, dataType: "json", data: i, context: n.currentForm, success: function success(r) {
            var i,
                o,
                l,
                u = r === !0 || "true" === r;n.settings.messages[a.name].remote = s.originalMessage, u ? (l = n.formSubmitted, n.prepareElement(a), n.formSubmitted = l, n.successList.push(a), delete n.invalid[a.name], n.showErrors()) : (i = {}, o = r || n.defaultMessage(a, "remote"), i[a.name] = s.message = e.isFunction(o) ? o(t) : o, n.invalid[a.name] = !0, n.showErrors(i)), s.valid = u, n.stopRequest(a, u);
          } }, r)), "pending");
      } } });var t,
      a = {};e.ajaxPrefilter ? e.ajaxPrefilter(function (e, t, r) {
    var n = e.port;"abort" === e.mode && (a[n] && a[n].abort(), a[n] = r);
  }) : (t = e.ajax, e.ajax = function (r) {
    var n = ("mode" in r ? r : e.ajaxSettings).mode,
        i = ("port" in r ? r : e.ajaxSettings).port;return "abort" === n ? (a[i] && a[i].abort(), a[i] = t.apply(this, arguments), a[i]) : t.apply(this, arguments);
  });
});var DateFormatter;!function () {
  "use strict";
  var e, _t, _a, r, n, i, s;i = 864e5, s = 3600, e = function e(_e, t) {
    return "string" == typeof _e && "string" == typeof t && _e.toLowerCase() === t.toLowerCase();
  }, _t = function t(e, a, r) {
    var n = e.toString();return r = r || "0", n.length < a ? _t(r + n, a) : n;
  }, _a = function a(e) {
    ...
    var t = this,
      ...
      var t,
          a = this;return t = r(e, a.dateSettings.monthsShort) + 1, 0 === t && (t = r(e, a.dateSettings.months) + 1), t;
      ...
      var r,
          ...
          g = !1,
          p = m.dateSettings,
          v = { date: null, year: null, month: null, day: null, hour: 0, min: 0, sec: 0 };if (!t) return null;if (t instanceof Date) return t;if ("U" === a) return i = parseInt(t), i ? new Date(1e3 * i) : t;switch (typeof t === "undefined" ? "undefined" : _typeof(t)) {case "number":
          return new Date(t);case "string":
          break;default:
          return null;}if (r = a.match(m.validParts), !r || 0 === r.length) throw new Error("Invalid date format definition.");for (n = t.replace(m.separators, "\0").split("\0"), i = 0; i < n.length; i++) {
        switch (s = n[i], o = parseInt(s), r[i]) {case "y":case "Y":
            if (!o) return null;h = s.length, v.year = 2 === h ? parseInt((o < 70 ? "20" : "19") + s) : o, f = !0;break;case "m":case "n":case "M":case "F":
            if (isNaN(o)) {
              if (l = m.getMonth(s), !(l > 0)) return null;v.month = l;
            } else {
              if (!(o >= 1 && o <= 12)) return null;v.month = o;
            }f = !0;break;case "d":case "j":
            if (!(o >= 1 && o <= 31)) return null;v.day = o, f = !0;break;case "g":case "h":
            if (u = r.indexOf("a") > -1 ? r.indexOf("a") : r.indexOf("A") > -1 ? r.indexOf("A") : -1, c = n[u], u !== -1) d = e(c, p.meridiem[0]) ? 0 : e(c, p.meridiem[1]) ? 12 : -1, o >= 1 && o <= 12 && d !== -1 ? v.hour = o % 12 === 0 ? d : o + d : o >= 0 && o <= 23 && (v.hour = o);else {
              if (!(o >= 0 && o <= 23)) return null;v.hour = o;
            }g = !0;break;case "G":case "H":
            if (!(o >= 0 && o <= 23)) return null;v.hour = o, g = !0;break;case "i":
            if (!(o >= 0 && o <= 59)) return null;v.min = o, g = !0;break;case "s":
            if (!(o >= 0 && o <= 59)) return null;v.sec = o, g = !0;}
      }if (f === !0 && v.year && v.month && v.day) v.date = new Date(v.year, v.month - 1, v.day, v.hour, v.min, v.sec, 0);else {
        if (g !== !0) return null;v.date = new Date(0, 0, 0, v.hour, v.min, v.sec, 0);
      }return v.date;
      ...
      if ("string" != typeof e) return e;var a,
          ...
          d = /^[djmn]/g,
          h = t.match(l.validParts),
          c = new Date(),
          m = 0;if (!d.test(h[0])) return e;for (n = 0; n < u.length; n++) {
        if (m = 2, s = u[n], o = parseInt(s.substr(0, 2)), isNaN(o)) return null;switch (n) {case 0:
            "m" === h[0] || "n" === h[0] ? c.setMonth(o - 1) : c.setDate(o);break;case 1:
            "m" === h[0] || "n" === h[0] ? c.setDate(o) : c.setMonth(o - 1);break;case 2:
            if (r = c.getFullYear(), a = s.length, m = a < 4 ? a : 4, r = parseInt(a < 4 ? r.toString().substr(0, 4 - a) + s : s.substr(0, 4)), !r) return null;c.setFullYear(r);break;case 3:
            c.setHours(o);break;case 4:
            c.setMinutes(o);break;case 5:
            c.setSeconds(o);}i = s.substr(m), i.length > 0 && u.splice(n + 1, 0, i);
      }return c;
      ...
      var r,
        ...
        return r[e] ? r[e]() : t;
          ...
          var e = new Date(r.Y(), r.n() - 1, r.j()),
              t = new Date(r.Y(), 0, 1);return Math.round((e - t) / i);
        }, W: function W() {
          var e = new Date(r.Y(), r.n() - 1, r.j() - r.N() + 3),
              a = new Date(e.getFullYear(), 0, 4);return _t(1 + Math.round((e - a) / i / 7), 2);
        }, F: function F() {
          ...
          var e = r.n(),
              t = r.W(),
              a = r.Y();return a + (12 === e && t < 9 ? 1 : 1 === e && t > 9 ? -1 : 0);
        }, Y: function Y() {
          ...
          var e = r.G() < 12 ? 0 : 1;return o.meridiem[e];
        }, B: function B() {
          var e = a.getUTCHours() * s,
              r = 60 * a.getUTCMinutes(),
              n = a.getUTCSeconds();return _t(Math.floor((e + r + n + s) / 86.4) % 1e3, 3);
        }, g: function g() {
          return r.G() % 12 || 12;
        }, G: function G() {
          return a.getHours();
          ...
          var e = (String(a).match(n.tzParts) || [""]).pop().replace(n.tzClip, "");return e || "UTC";
        }, Z: function Z() {
      ...
      var a,
          ...
          o = this,
          l = "",
          u = "\\";if ("string" == typeof e && (e = o.parseDate(e, t), !e)) return null;if (e instanceof Date) {
        for (n = t.length, a = 0; a < n; a++) {
          s = t.charAt(a), "S" !== s && s !== u && (a > 0 && t.charAt(a - 1) === u ? l += s : (i = o.parseFormat(s, e), a !== n - 1 && o.intParts.test(s) && "S" === t.charAt(a + 1) && (r = parseInt(i) || 0, i += o.dateSettings.ordinal(r)), l += i));
        }return l;
      }return "";
    } };
}();var laravelValidation;laravelValidation = { implicitRules: ["Required", "Confirmed"], init: function init() {
  ...
  }, arrayRules: function arrayRules(e) {
    var t = {},
        a = $.data(e.form, "validator"),
        r = a.arrayRulesCache;return e.name.indexOf("[") === -1 ? t : (e.name in r || (r[e.name] = {}), $.each(a.settings.rules, function (a, n) {
      if (a in r[e.name]) $.extend(t, r[e.name][a]);else {
        r[e.name][a] = {};var i = laravelValidation.helpers.regexFromWildcard(a);if (e.name.match(i)) {
          var s = $.validator.normalizeRule(n) || {};r[e.name][a] = s, $.extend(t, s);
        }
      }
    }), t);
    ...
    $.validator.addMethod("laravelValidation", function (e, t, a) {
      var r = this,
          n = !0,
          i = this.previousValue(t),
          s = [];return $.each(a, function (e, t) {
        t[3] || laravelValidation.implicitRules.indexOf(t[0]) !== -1 ? s.unshift(t) : s.push(t);
      }), $.each(s, function (a, s) {
        var o = s[3] || laravelValidation.implicitRules.indexOf(s[0]) !== -1,
            l = s[0],
            u = s[2];return !o && r.optional(t) ? (n = "dependency-mismatch", !1) : (n = void 0 !== laravelValidation.methods[l] && laravelValidation.methods[l].call(r, e, t, s[1], function (a) {
          if (r.settings.messages[t.name].laravelValidationRemote = i.originalMessage, a) {
            var n = r.formSubmitted;r.prepareElement(t), r.formSubmitted = n, r.successList.push(t), delete r.invalid[t.name], r.showErrors();
          } else {
            var s = {};s[t.name] = i.message = $.isFunction(u) ? u(e) : u, r.invalid[t.name] = !0, r.showErrors(s);
          }r.showErrors(r.errorMap), i.valid = a;
        }), n !== !0 ? (r.settings.messages[t.name] || (r.settings.messages[t.name] = {}), r.settings.messages[t.name].laravelValidation = u, !1) : void 0);
      }), n;
      ...
      var r = !1,
          ...
          i = t.name,
          s = n[1],
          o = n[2];if ($.each(a, function (e, t) {
        r = r || t[3];
      }), !r && this.optional(t)) return "dependency-mismatch";var l,
          u,
          d = this.previousValue(t);this.settings.messages[t.name] || (this.settings.messages[t.name] = {}), d.originalMessage = this.settings.messages[t.name].laravelValidationRemote, this.settings.messages[t.name].laravelValidationRemote = d.message;var h = "string" == typeof h && { url: h } || h;if (d.old === e) return d.valid;d.old = e, l = this, this.startRequest(t), u = $(l.currentForm).serializeArray(), u.push({ name: "_jsvalidation", value: i }), u.push({ name: "_jsvalidation_validate_all", value: o });var c = $(l.currentForm).attr("method");return $(l.currentForm).find('input[name="_method"]').length && (c = $(l.currentForm).find('input[name="_method"]').val()), $.ajax($.extend(!0, { mode: "abort", port: "validate" + t.name, dataType: "json", data: u, context: l.currentForm, url: $(l.currentForm).attr("action"), type: c, beforeSend: function beforeSend(e) {
          if ("get" !== $(l.currentForm).attr("method").toLowerCase() && s) return e.setRequestHeader("X-XSRF-TOKEN", s);
        } }, h)).always(function (a, r) {
        var n, i, s, o;if ("error" === r) o = !1, a = laravelValidation.helpers.parseErrorResponse(a);else {
          if ("success" !== r) return;o = a === !0 || "true" === a;
        }l.settings.messages[t.name].laravelValidationRemote = d.originalMessage, o ? (s = l.formSubmitted, l.prepareElement(t), l.formSubmitted = s, l.successList.push(t), delete l.invalid[t.name], l.showErrors()) : (n = {}, i = a || l.defaultMessage(t, "remote"), n[t.name] = d.message = $.isFunction(i) ? i(e) : i[0], l.invalid[t.name] = !0, l.showErrors(n)), l.showErrors(l.errorMap), d.valid = o, l.stopRequest(t, o);
      }), "pending";
    }, "");
  } }, $(function () {
  laravelValidation.init();
}), $.extend(!0, laravelValidation, { helpers: { numericRules: ["Integer", "Numeric"], fileinfo: function fileinfo(e, t) {
      var a = e.value;return t = "undefined" != typeof t ? t : 0, null !== e.files && "undefined" != typeof e.files[t] && { file: a, extension: a.substr(a.lastIndexOf(".") + 1), size: e.files[t].size / 1024, type: e.files[t].type };
    }, selector: function selector(e) {
      var t = [];$.isArray(e) || (e = [e]);for (var a = 0; a < e.length; a++) {
        t.push("[name='" + e[a] + "']");
      }return t.join();
    }, hasNumericRules: function hasNumericRules(e) {
      return this.hasRules(e, this.numericRules);
    }, hasRules: function hasRules(e, t) {
      var a = !1;"string" == typeof t && (t = [t]);var r = $.data(e.form, "validator"),
          n = [],
          i = r.arrayRulesCache;return e.name in i && $.each(i[e.name], function (e, t) {
        n.push(t);
      }), e.name in r.settings.rules && n.push(r.settings.rules[e.name]), $.each(n, function (e, r) {
        if ("laravelValidation" in r) for (var n = r.laravelValidation, i = 0; i < n.length; i++) {
          if ($.inArray(n[i][0], t) !== -1) return a = !0, !1;
        }
      }), a;
    ...
    }, getLaravelValidation: function getLaravelValidation(e, t) {
      var a = void 0;return $.each($.validator.staticRules(t), function (t, r) {
    ...
    }, RequiredWith: function RequiredWith(e, t, a) {
      var r = this,
          n = !1,
          i = this;return $.each(a, function (e, a) {
        var s = laravelValidation.helpers.dependentElement(i, t, a);n = n || void 0 !== s && $.validator.methods.required.call(r, i.elementValue(s), s, !0);
      }), !n || $.validator.methods.required.call(this, e, t, !0);
    }, RequiredWithAll: function RequiredWithAll(e, t, a) {
      var r = this,
          n = !0,
          i = this;return $.each(a, function (e, a) {
        var s = laravelValidation.helpers.dependentElement(i, t, a);n = n && void 0 !== s && $.validator.methods.required.call(r, i.elementValue(s), s, !0);
      }), !n || $.validator.methods.required.call(this, e, t, !0);
    }, RequiredWithout: function RequiredWithout(e, t, a) {
      var r = this,
          n = !1,
          i = this;return $.each(a, function (e, a) {
        var s = laravelValidation.helpers.dependentElement(i, t, a);n = n || void 0 === s || !$.validator.methods.required.call(r, i.elementValue(s), s, !0);
      }), !n || $.validator.methods.required.call(this, e, t, !0);
    }, RequiredWithoutAll: function RequiredWithoutAll(e, t, a) {
      var r = this,
          n = !0,
          i = this;return $.each(a, function (e, a) {
        var s = laravelValidation.helpers.dependentElement(i, t, a);n = n && (void 0 === s || !$.validator.methods.required.call(r, i.elementValue(s), s, !0));
      ...
      var r = laravelValidation.helpers.dependentElement(this, t, a[0]);if (void 0 !== r) {
        var n = String(this.elementValue(r));if ("undefined" != typeof n) {
          var i = a.slice(1);if ($.inArray(n, i) !== -1) return $.validator.methods.required.call(this, e, t, !0);
        }
      }return !0;
    }, RequiredUnless: function RequiredUnless(e, t, a) {
      var r = laravelValidation.helpers.dependentElement(this, t, a[0]);if (void 0 !== r) {
        var n = String(this.elementValue(r));if ("undefined" != typeof n) {
          var i = a.slice(1);if ($.inArray(n, i) !== -1) return !0;
        }
      }return $.validator.methods.required.call(this, e, t, !0);
    }, Confirmed: function Confirmed(e, t, a) {
      return laravelValidation.methods.Same.call(this, e, t, a);
    }, Same: function Same(e, t, a) {
      var r = laravelValidation.helpers.dependentElement(this, t, a[0]);return void 0 !== r && String(e) === String(this.elementValue(r));
    }, InArray: function InArray(e, t, a) {
      if ("undefined" == typeof a[0]) return !1;for (var r = this.elements(), n = !1, i = laravelValidation.helpers.regexFromWildcard(a[0]), s = 0; s < r.length; s++) {
        var o = r[s].name;if (o.match(i)) {
          var l = laravelValidation.methods.Same.call(this, e, t, [o]);n = n || l;
        }
      }return n;
    }, Distinct: function Distinct(e, t, a) {
      if ("undefined" == typeof a[0]) return !1;for (var r = this.elements(), n = !1, i = laravelValidation.helpers.regexFromWildcard(a[0]), s = 0; s < r.length; s++) {
        var o = r[s].name;if (o !== t.name && o.match(i)) {
          var l = laravelValidation.methods.Same.call(this, e, t, [o]);n = n || l;
        }
      }return !n;
      ...
      var t = new RegExp("^(?:(yes|on|1|true))$", "i");return t.test(e);
    }, Array: function Array(e) {
      return $.isArray(e);
    }, Boolean: function Boolean(e) {
      var t = new RegExp("^(?:(true|false|1|0))$", "i");return t.test(e);
    }, Integer: function Integer(e) {
      var t = new RegExp("^(?:-?\\d+)$", "i");return t.test(e);
      ...
      if ($.isArray(e) && laravelValidation.helpers.hasRules(t, "Array")) {
        var r = laravelValidation.helpers.arrayDiff(e, a);return 0 === Object.keys(r).length;
      ...
      if (!(window.File && window.FileReader && window.FileList && window.Blob)) return !0;var r = $.map(a, function (e) {
        return e.toLowerCase();
      }),
          n = laravelValidation.helpers.fileinfo(t);return n !== !1 && r.indexOf(n.extension.toLowerCase()) !== -1;
    }, Mimetypes: function Mimetypes(e, t, a) {
      if (!(window.File && window.FileReader && window.FileList && window.Blob)) return !0;var r = $.map(a, function (e) {
        return e.toLowerCase();
      }),
          n = laravelValidation.helpers.fileinfo(t);return n !== !1 && r.indexOf(n.type.toLowerCase()) !== -1;
      ...
      if (!(window.File && window.FileReader && window.FileList && window.Blob)) return !0;if (null === element.files || "undefined" == typeof element.files[0]) return !1;var fr = new FileReader();return fr.onload = function () {
        var img = new Image();img.onload = function () {
          var height = parseFloat(img.naturalHeight),
              width = parseFloat(img.naturalWidth),
              ratio = width / height,
              notValid = params.width && parseFloat(params.width !== width) || params.min_width && parseFloat(params.min_width) > width || params.max_width && parseFloat(params.max_width) < width || params.height && parseFloat(params.height) !== height || params.min_height && parseFloat(params.min_height) > height || params.max_height && parseFloat(params.max_height) < height || params.ratio && ratio !== parseFloat(eval(params.ratio));callback(!notValid);
        }, img.onerror = function () {
          callback(!1);
        }, img.src = fr.result;
      }, fr.readAsDataURL(element.files[0]), "pending";
    }, Alpha: function Alpha(e) {
      if ("string" != typeof e) return !1;var t = new RegExp("^(?:^[a-zà-ü]+$)$", "i");return t.test(e);
    }, AlphaNum: function AlphaNum(e) {
      if ("string" != typeof e) return !1;var t = new RegExp("^(?:^[a-z0-9à-ü]+$)$", "i");return t.test(e);
    }, AlphaDash: function AlphaDash(e) {
      if ("string" != typeof e) return !1;var t = new RegExp("^(?:^[a-z0-9à-ü_-]+$)$", "i");return t.test(e);
    }, Regex: function Regex(e, t, a) {
      var r = ["x", "s", "u", "X", "U", "A"],
          n = new RegExp("^(?:/)(.*\\/?[^/]*|[^/]*)(?:/)([gmixXsuUAJ]*)?$"),
          i = a[0].match(n);if (null === i) return !1;var s = [];if (void 0 !== i[2]) {
        s = i[2].split("");for (var o = 0; o < s.length < o; o++) {
          if (r.indexOf(s[o]) !== -1) return !0;
        }
      }var l = new RegExp("^(?:" + i[1] + ")$", s.join());return l.test(e);
      ...
      var r = parseFloat(a);if (isNaN(r)) {
        var n = laravelValidation.helpers.dependentElement(this, t, a);if (void 0 === n) return !1;r = laravelValidation.helpers.parseTime(this.elementValue(n), n);
      }var i = laravelValidation.helpers.parseTime(e, t);return i !== !1 && i < r;

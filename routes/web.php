 ...
 * Utable routes
 */
Route::get('/web/getFilesForField', 'TableController@getFilesForField')->name('getFilesForField');
Route::get('/web/getTables', 'TableController@getTables')->name('getTables');
Route::post('/web/getSelectedTable', 'TableController@getSelectedTable')->name('getSelectedTable');
Route::get('/web/loadFilter', 'TableController@loadFilter')->name('loadFilter');
Route::get('/web/favoriteToggleTable', 'TableController@favoriteToggleTable')->name('favoriteToggleTable');
Route::get('/web/favoriteToggleRow', 'TableController@favoriteToggleRow')->name('favoriteToggleRow');
Route::get('/web/showHideColumnToggle', 'TableController@showHideColumnToggle')->name('showHideColumnToggle');
Route::get('/web/getDDLdatas', 'TableController@getDDLdatas')->name('getDDLdatas');
Route::get('/web/getRefDDL', 'TableController@getRefDDL')->name('getRefDDL');
Route::get('/web/getRightsDatas', 'TableController@getRightsDatas')->name('getRightsDatas');
Route::get('/web/addRightsDatas', 'TableController@addRightsDatas')->name('addRightsDatas');
Route::get('/web/updateRightsDatas', 'TableController@updateRightsDatas')->name('updateRightsDatas');
Route::get('/web/deleteRightsDatas', 'TableController@deleteRightsDatas')->name('deleteRightsDatas');
Route::get('/web/toggleAllrights', 'TableController@toggleAllrights')->name('toggleAllrights');
Route::get('/web/ajaxSearchUser', 'TableController@ajaxSearchUser')->name('ajaxSearchUser');
Route::get('/web/getFavoritesForTable', 'TableController@getFavoritesForTable')->name('getFavoritesForTable');
Route::get('/web/getDistinctData', 'TableController@getDistinctData')->name('getDistinctData');
Route::get('/web/changeOrder', 'TableController@changeOrder')->name('changeOrder');
Route::get('/web/changeSettingsRowOrder', 'TableController@changeSettingsRowOrder')->name('changeSettingsRowOrder');
Route::get('/web/settingsForCreateMySQL', 'AppController@showSettingsForCreateTableMySQL')->name('showSettingsForCreateTableMySQL');
...
Route::group(['middleware' => 'database.change'], function () {
    Route::get('/web/menutree_addfolder', 'TableController@menutree_addfolder')->name('menutree_addfolder');
    Route::get('/web/menutree_renamefolder', 'TableController@menutree_renamefolder')->name('menutree_renamefolder');
    Route::get('/web/menutree_deletefolder', 'TableController@menutree_deletefolder')->name('menutree_deletefolder');
    Route::get('/web/menutree_movenode', 'TableController@menutree_movenode')->name('menutree_movenode');
    Route::get('/web/menutree_createlink', 'TableController@menutree_createlink')->name('menutree_createlink');
    Route::get('/web/menutree_removelink', 'TableController@menutree_removelink')->name('menutree_removelink');
    Route::get('/web/addTableRow', 'TableController@addTableRow')->name('addTableRow');
    Route::get('/web/updateTableRow', 'TableController@updateTableRow')->name('updateTableRow');
    Route::get('/web/deleteTableRow', 'TableController@deleteTableRow')->name('deleteTableRow');
    Route::get('/web/deleteAllTable', 'TableController@deleteTable')->name('deleteTable');
});
